        ...
        if path == "/tool/video-downloader":
            ...
            <main class="wrap">
              ...
              <section class="card" style="margin-top:18px">
                ...
                <p class="mini">Modo local é gratuito e roda no notebook. OpenAI é opcional para quem quiser usar API paga/mais rápida.</p>
                <div class="row">
                  <div>
                    <label>Modo</label>
              ...
              <section class="card" style="margin-top:18px">
                ...
                <div class="actions">
                  ...
                  <div>
                    <h3>Transcrição</h3>
                    <p class="mini">Gera TXT, MD com timestamps e JSON. Por padrão usa o modo local gratuito.</p>
