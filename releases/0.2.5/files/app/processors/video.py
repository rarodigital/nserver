...
class VideoProcessor(Processor):
    ...
    def download_video(self, url: str, quality: str = "720", ext: str = "mp4", destination: str = "server") -> ProcessorResult:
        ...
        file_path = self._last_existing_file(proc.stdout, outdir)
        data = {"folder": str(outdir), "file": str(file_path) if file_path else "", "downloadable": bool(file_path), "delete_after_download": destination == "device", "log": proc.stdout[-1000:]}
    ...
    def _last_existing_file(self, stdout: str, folder: Path) -> Path | None:
