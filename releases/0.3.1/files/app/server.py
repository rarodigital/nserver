            ...
            <main class="wrap">
              ...
              <section class="card" style="margin-top:18px">
                ...
                <div class="actions">
                  ...
                  <div>
                    <h3>Transcrição</h3>
                    <p class="mini">Padrão: modo local gratuito. Gera TXT, MD com timestamps e JSON.</p>
