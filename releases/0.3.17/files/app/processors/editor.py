...
class VideoEditorProcessor(Processor):
    ...
    def render_cuts(self, source: Path, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        subprocess.run([sys.executable, str(script), str(cuts_path), "--video", str(source), "-o", str(out)], check=True, capture_output=True, text=True)
    ...
    def caption_render(self, source: Path, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        subprocess.run([sys.executable, str(script), str(source), str(cfg_path), "-o", str(out)], check=True, capture_output=True, text=True)
