        ...
        if path == "/tool/video-editor":
            ...
            <main class="wrap">
              ...
              <section id="cutControls" class="card" style="margin-top:18px">
                ...
                <div class="row">
                  <button onclick="applyPreset('dry')">Reels seco</button>
                ...
                <div class="row">
                  <div><label>Threshold</label><input id="noise" value="-40dB"></div>
                  <div><label>Duração mínima</label><input id="minSilence" value="0.75"></div>
                  <div><label>Padding antes</label><input id="padBefore" value="0.30"></div>
                  <div><label>Padding depois</label><input id="padAfter" value="0.30"></div>
                  <div><label>Ignorar corte menor</label><input id="ignoreCut" value="0.20"></div>
                  <div><label>Keep mínimo</label><input id="minKeep" value="0.25"></div>
                  <div><label>Unir cortes até</label><input id="joinGap" value="0.15"></div>
                </div>
                <div class="row">
              ...
              <section id="timelineCard" class="card" style="margin-top:18px">
                ...
                <div id="selectedCutPanel" class="result muted">Selecione um trecho na timeline ou na lista para ajustar.</div>
...
function selectCut(id){CUTS=getCuts(); SELECTED_ID=id; renderCuts(); const it=selectedItem(); if(it) seekToCut(id);}
