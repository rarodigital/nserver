...
def is_intermediate_media(path: Path) -> bool:
    ...
    if name.endswith((".part", ".ytdl")):
        return True
    # Hide yt-dlp format intermediates such as .f398.mp4 or .f251.webm from Biblioteca.
    return bool(re.search(r"\.f\d+\.(mp4|webm|m4a|opus)$", name))
            ...
            <main class="wrap">
              ...
              <section class="card" style="margin-top:18px">
                ...
                <div class="actions">
                  ...
                  <div>
                    <h3>Transcrição</h3>
                    <p class="mini">Padrão: modo local gratuito. Escolha apenas os formatos que quer gerar.</p>
