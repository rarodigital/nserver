        ...
        if path == "/tool/video-editor":
            ...
            <main class="wrap">
              ...
              <section id="cutPanel" class="card" style="margin-top:18px">
                ...
                <div class="row">
                  <select id="sourceType" onchange="toggleSource()"><option value="library">Biblioteca</option><option value="upload">Upload</option><option value="url">URL / Drive / YouTube</option></select>
                  <select id="source"></select>
                  <input id="uploadFile" type="file" style="display:none" />
                  <input id="sourceUrl" placeholder="Cole o link do vídeo" style="display:none" />
...
function toggleSource(){const t=document.getElementById('sourceType').value;document.getElementById('source').style.display=t==='library'?'block':'none';document.getElementById('uploadFile').style.display=t==='upload'?'block':'none';document.getElementById('sourceUrl').style.display=t==='url'?'block':'none';}
